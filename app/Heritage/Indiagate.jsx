  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>India Gate</Text>
      </View>

      {/* Main Image Card */}
      <View style={styles.imageCard}>
        <Image
          source={{ uri: "https://www.culturalindia.net/iliimages/India-Gate-ili-49-img-1.jpg" }}
          style={styles.image}
        />
      </View>
      ...
      <View style={styles.contentCard}>
        ...
        <Text style={styles.description}>
          The India Gate, located in the heart of New Delhi, is a majestic war memorial.
Designed by Sir Edwin Lutyens, it was built in 1931 to honor the soldiers of the Indian Army who lost their lives in World War I.
Standing 42 meters high, it resembles the Arc de Triomphe in Paris and is surrounded by lush lawns.
At its base burns the Amar Jawan Jyoti, an eternal flame paying tribute to the martyrs of the nation.
        </Text>
      </View>
